...
export default class DisasterService {
    ...
    static getAllActiveDisasters = async () => {
        try {
            const response = await axios.get(`${DisasterService.trimTrailingSlash(Config.backendUrl())}disasters`);
    ...
    static getDisasterById = async (disasterId) => {
        try {
            const response = await axios.get(`${DisasterService.trimTrailingSlash(Config.backendUrl())}disasters/${disasterId}`);
            return response.data;
        } catch (error) {
            return {
                failed: true,
    ...
    static getActiveDisastersCount = async () => {
        try {
            const response = await axios.get(`${DisasterService.trimTrailingSlash(Config.backendUrl())}disasters/count`);
    ...
    static addNewDisaster = async (disasterData, token) => {
        try {
            ...
            const response = await axios.post(`${DisasterService.trimTrailingSlash(Config.backendUrl())}disasters`, disasterData, {
    ...
    static updateDisasterDetails = async (disasterData, token) => {
        try {
            ...
            const response = await axios.put(`${DisasterService.trimTrailingSlash(Config.backendUrl())}disasters`, disasterData, {
                headers: { Authorization: `Bearer ${token}` },
            });
            return response.data;
        } catch (error) {
    ...
    static deleteDisaster = async (disasterId, token) => {
        try {
            const response = await axios.delete(`${DisasterService.trimTrailingSlash(Config.backendUrl())}disasters`, {
                data: { id: disasterId },
                headers: { Authorization: `Bearer ${token}` },
            });
            return response.data;
